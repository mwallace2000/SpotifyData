...
def main():
	...
	if 'playlists' in args.dump:
		...
		playlist_data = [i for i in playlist_data if i["name"] in ["Maybe Songs", "Possible Songs"]]
	...
	with open(args.file, 'w', encoding='utf-8') as f:
		...
		# Tab-separated file.
			...
			f.write(playlist['name'] + '\tArtists' +'\tID'+'\tExCol'+ '\r\n')
			for playlist in playlists:
				if playlist['name'] in ["Maybe Songs", "Possible Songs"]:
