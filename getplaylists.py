...
def main():
	...
	if 'playlists' in args.dump:
		...
		playlist_data = [i for i in playlist_data if i["name"] == "Other Songs I Know"]
	...
	with open(args.file, 'w', encoding='utf-8') as f:
		...
		# Tab-separated file.
			...
			for playlist in playlists:
				if playlist['name'] == "Other Songs I Know":
					f.write("Other Songs I Know" + '\tArtists' +'\tID'+ '\tExCol'+ '\r\n')
