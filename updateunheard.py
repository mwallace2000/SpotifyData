...
def main():
	...
	if 'playlists' in args.dump:
		...
		playlist_data = [i for i in playlist_data if i["name"] in ["HH2", "HH3" ,"HH4", "Songs I Haven't Heard", "HH5"]]
	...
	with open(args.file, 'w', encoding='utf-8') as f:
		...
		# Tab-separated file.
			...
			f.write("Queued Songs" + '\tArtists' +'\tID'+ '\tExCol'+ '\r\n')
			for playlist in playlists:
				if playlist['name'] in ["HH2", "Songs I Haven't Heard", "HH3", "HH4", "HH5"]:
